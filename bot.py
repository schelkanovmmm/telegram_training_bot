...
PROGRAMS = {
    "A": {
        ...
        "exercises": [
            {
                "group": "Ноги", "exercise": "Присед со штангой",
                "sets": 4, "reps": "5–6", "rpe": "RIR 1–2", "step": "+2.5–5 кг",
                "rest": "2–3 мин",
                "desc": (
                    "🏋️ ПРИСЕД СО ШТАНГОЙ\n"
                    "Тип: многосуставное, силовое\n\n"
                    "Техника:\n"
                    "• Штанга на трапециях, хват чуть шире плеч\n"
                    "• Стопы на ширине плеч, носки развёрнуты ~30°\n"
                    "• Спина нейтральная, грудь вперёд, взгляд прямо\n"
                    "• Колени идут строго по линии носков\n"
                    "• Опускайся ниже параллели, если позволяет подвижность\n"
                    "• Подъём — мощно, не теряй напряжение спины\n\n"
                    "Отдых: 2–3 мин\n"
                    "RPE: RIR 1–2 (оставляй 1–2 повтора в запасе)\n"
                    "Прогрессия: +2.5–5 кг, когда все 4×6 сделаны чисто"
                )
            },
            {
                "group": "Грудь", "exercise": "Жим штанги лёжа",
                "sets": 4, "reps": "5–6", "rpe": "RIR 1–2", "step": "+2.5 кг",
                "rest": "2–3 мин",
                "desc": (
                    "🏋️ ЖИМ ШТАНГИ ЛЁЖА\n"
                    "Тип: многосуставное, силовое\n\n"
                    "Техника:\n"
                    "• Лопатки сведены и опущены, небольшой прогиб в пояснице\n"
                    "• Хват: средний (не слишком широкий)\n"
                    "• Штанга опускается к нижней части груди\n"
                    "• Локти 45–75° от корпуса, не разводи в стороны\n"
                    "• Ступни прижаты к полу, создавай «мост»\n"
                    "• Жим мощно, полное разгибание вверху\n\n"
                    "Отдых: 2–3 мин\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +2.5 кг при выполнении 4×6 чисто"
                )
            },
            {
                "group": "Спина", "exercise": "Подтягивания с весом",
                "sets": 4, "reps": "5–6", "rpe": "RIR 1–2", "step": "+1.25–2.5 кг",
                "rest": "2–3 мин",
                "desc": (
                    "🏋️ ПОДТЯГИВАНИЯ С ВЕСОМ\n"
                    "Тип: многосуставное, силовое\n\n"
                    "Техника:\n"
                    "• Хват пронация (ладони от себя), чуть шире плеч\n"
                    "• Лопатки вниз перед началом движения\n"
                    "• Тяни локти к бёдрам, не к полу\n"
                    "• Подбородок выше перекладины, полное опускание вниз\n"
                    "• Контролируй эксцентрик (опускание ~2 сек)\n"
                    "• Дополнительный вес — пояс или жилет\n\n"
                    "Отдых: 2–3 мин\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +1.25–2.5 кг"
                )
            },
            {
                "group": "Спина", "exercise": "Тяга штанги в наклоне",
                "sets": 3, "reps": "6–8", "rpe": "RIR 1–2", "step": "+2.5 кг",
                "rest": "2 мин",
                "desc": (
                    ...
                    "• Хват пронация или нейтральный\n"
                    "• Тяни к поясу, локти близко к корпусу\n"
                    "• Сводить лопатки в верхней точке\n"
                    "• Не используй инерцию, движение контролируемое\n\n"
                    "Отдых: 2 мин\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +2.5 кг"
                )
            ...
            {
                "group": "Плечи", "exercise": "Жим гантелей сидя",
                "sets": 4, "reps": "6–8", "rpe": "RIR 1–2", "step": "+1–2 кг",
                "rest": "2 мин",
                "desc": (
                    "🏋️ ЖИМ ГАНТЕЛЕЙ СИДЯ\n"
                    "Тип: многосуставное, плечевой пояс\n\n"
                    "Техника:\n"
                    "• Спина прямая, поясница прижата к спинке\n"
                    "• Стартовая позиция — гантели на уровне ушей\n"
                    "• Жми строго вверх, не сводя гантели\n"
                    "• Полное разгибание вверху, но не замок\n"
                    "• Локти чуть впереди корпуса, не в стороны\n\n"
                    "Отдых: 2 мин\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +1–2 кг"
                )
            ...
            {
                "group": "Плечи", "exercise": "Face Pull",
                "sets": 3, "reps": "12–15", "rpe": "контроль", "step": "след. стек",
                "rest": "60 сек",
                "desc": (
                    "💪 FACE PULL\n"
                    "Тип: изолирующее, задняя дельта / вращатели\n\n"
                    "Техника:\n"
                    "• Канатная рукоять на уровне лица или выше\n"
                    "• Тяни к лицу, разводя локти в стороны и назад\n"
                    "• В конечной точке — руки как буква W\n"
                    "• Контролируй движение, без рывков\n"
                    "• Чувствуй заднюю дельту и вращатели\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль (не до отказа, фокус на технику)\n"
                    "Прогрессия: следующий стек при чистой технике"
                )
            },
            {
                "group": "Трапеция", "exercise": "Шраги со штангой",
                "sets": 3, "reps": "12–15", "rpe": "контроль", "step": "+2.5–5 кг",
                "rest": "60 сек",
                "desc": (
                    "💪 ШРАГИ СО ШТАНГОЙ\n"
                    "Тип: изолирующее, верхняя трапеция\n\n"
                    "Техника:\n"
                    "• Хват чуть шире плеч, руки прямые, штанга перед бёдрами\n"
                    "• Поднимай плечи строго вверх — к ушам\n"
                    "• Задержка в верхней точке 1–2 сек — сжимай трапецию\n"
                    "• НЕ вращай плечами — только вертикальное движение\n"
                    "• Медленно опускай — полная амплитуда\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль (не до отказа)\n"
                    "Прогрессия: +2.5–5 кг при чистой технике"
                )
            },
            {
                "group": "Пресс", "exercise": "Подъём ног в висе",
                "sets": 3, "reps": "10–12", "rpe": "контроль", "step": "+1–2 повт",
                "rest": "60 сек",
                "desc": (
                    "💪 ПОДЪЁМ НОГ В ВИСЕ\n"
                    "Тип: изолирующее, пресс / сгибатели бедра\n\n"
                    "Техника:\n"
                    "• Вис на перекладине, хват надёжный\n"
                    "• Поднимай прямые ноги (или согнутые для начинающих)\n"
                    "• Не раскачивайся — движение контролируемое\n"
                    "• В верхней точке — небольшая задержка\n"
                    "• Медленно опускай, не бросай ноги\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль\n"
            ...
            {
                "group": "Икры", "exercise": "Икры стоя",
                "sets": 4, "reps": "12–15", "rpe": "RIR 1–2", "step": "+2.5–5 кг",
                "rest": "60 сек",
                "desc": (
                    "💪 ИКРЫ СТОЯ\n"
                    "Тип: изолирующее, икроножная мышца\n\n"
                    "Техника:\n"
                    "• Носки на краю платформы/степа, пятки свисают\n"
                    "• Опускайся максимально вниз — полное растяжение\n"
                    "• Поднимайся на максимальную высоту — пик сокращения\n"
                    "• Задержка 1–2 сек в верхней точке\n"
                    "• Медленный эксцентрик 2–3 сек — это ключевой момент\n"
                    "• Работа в полной амплитуде — без читинга\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +2.5–5 кг"
                )
        ...
        "exercises": [
            {
                ...
                "sets": 3, "reps": "8–10", "rpe": "7–9", "step": "+1–2 кг",
                "rest": "90 сек",
                "desc": (
                    "🔥 ЖИМ ГАНТЕЛЕЙ НА НАКЛОННОЙ СКАМЬЕ\n"
                    "Тип: многосуставное, гипертрофия верха груди\n\n"
                    "Техника:\n"
                    "• Угол скамьи 30–45°\n"
                    "• Лопатки сведены, гантели у плеч на старте\n"
                    "• Жим вверх и чуть к центру\n"
                    "• Полное растяжение внизу — амплитуда важна\n"
                    "• Контролируй эксцентрик 2–3 сек\n\n"
                    "Отдых: 90 сек\n"
                    "RPE: 7–9 (1–3 повтора в запасе)\n"
                    "Прогрессия: +1–2 кг"
                )
            },
            {
                "group": "Спина", "exercise": "Тяга горизонтального блока",
                "sets": 3, "reps": "10–12", "rpe": "7–9", "step": "след. стек",
                "rest": "90 сек",
                "desc": (
                    "🔥 ТЯГА ГОРИЗОНТАЛЬНОГО БЛОКА\n"
                    "Тип: многосуставное, гипертрофия спины\n\n"
                    "Техника:\n"
                    "• Сядь прямо, ноги слегка согнуты\n"
                    "• Тяни рукоять к животу, локти близко к корпусу\n"
                    "• Лопатки сводятся в конечной точке\n"
                    "• Не наклоняй корпус — работает только руки и спина\n"
                    "• Пик сокращения — задержи 1 сек\n\n"
                    "Отдых: 90 сек\n"
                    "RPE: 7–9\n"
            ...
            {
                "group": "Грудь", "exercise": "Cable Fly",
                "sets": 3, "reps": "12–15", "rpe": "контроль", "step": "след. стек",
                "rest": "60 сек",
                "desc": (
                    "🔥 CABLE FLY (кроссовер)\n"
                    "Тип: изолирующее, грудь\n\n"
                    "Техника:\n"
                    "• Блоки на уровне груди или чуть выше\n"
                    "• Небольшой наклон вперёд, руки широко по сторонам\n"
                    "• Сводить руки к центру дугообразным движением\n"
                    "• В центре — скрести руки для пика сокращения\n"
                    "• Ощущай растяжение груди в нижней точке\n"
                    "• НЕ сгибай локти — постоянная дуга\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль (акцент на растяжение и сокращение)\n"
                    "Прогрессия: следующий стек"
                )
            },
            {
                "group": "Грудь/Трицепс", "exercise": "Брусья с весом (грудь)",
                "sets": 3, "reps": "8–10", "rpe": "7–9", "step": "+1.25–2.5 кг",
                "rest": "90 сек",
                "desc": (
                    "🔥 БРУСЬЯ С ВЕСОМ (акцент грудь)\n"
                    "Тип: многосуставное, грудь + трицепс\n\n"
                    "Техника:\n"
                    "• Корпус наклонён вперёд (~15–20°) — акцент на грудь\n"
                    "• Широкий хват, локти развёрнуты наружу\n"
                    "• Опускайся до лёгкого растяжения грудных\n"
                    "• Жим мощно, без раскачки\n"
                    "• Доп. вес — пояс или жилет\n\n"
                    "Отдых: 90 сек\n"
                    "RPE: 7–9\n"
                    "Прогрессия: +1.25–2.5 кг"
                )
            },
            {
                ...
                "sets": 4, "reps": "12–15", "rpe": "контроль", "step": "+1 кг",
                "rest": "60 сек",
                "desc": (
                    "🔥 РАЗВЕДЕНИЯ ГАНТЕЛЕЙ В СТОРОНЫ\n"
                    "Тип: изолирующее, средняя дельта\n\n"
                    "Техника:\n"
                    "• Стой прямо, гантели вдоль бедер\n"
                    "• Поднимай до уровня плеч, локти чуть согнуты\n"
                    "• Мизинец чуть выше большого пальца (внешняя ротация)\n"
                    "• НЕ используй импульс — медленный подъём\n"
            ...
            },
            {
                ...
                "desc": (
                    ...
                    "Тип: изолирующее, средняя дельта\n\n"
                    "Техника:\n"
                    "• Блок на уровне бедра, стой боком\n"
                    "• Поднимай руку через сторону до уровня плеча\n"
                    "• Постоянное натяжение троса — преимущество перед гантелями\n"
                    "• Медленный контролируемый эксцентрик\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль\n"
                    "Прогрессия: следующий стек"
                )
            ...
            {
                "group": "Плечи", "exercise": "Face Pull / Reverse Pec Deck",
                "sets": 2, "reps": "12–15", "rpe": "контроль", "step": "след. стек",
                "rest": "60 сек",
                "desc": (
                    "🔥 FACE PULL / REVERSE PEC DECK\n"
                    "Тип: изолирующее, задняя дельта\n\n"
                    "Техника Face Pull:\n"
                    "• Канат к лицу, локти в стороны и вверх — форма W\n\n"
                    "Техника Reverse Pec Deck:\n"
                    "• Грудью к подушке, руки разводи назад\n"
                    "• Пик сокращения — сводить лопатки\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: контроль\n"
                    "Прогрессия: следующий стек"
                )
            ...
            {
                "group": "Бицепс", "exercise": "Бицепс (наклонная)",
                "sets": 3, "reps": "10–12", "rpe": "7–9", "step": "+1 кг",
                "rest": "60 сек",
                "desc": (
                    "🔥 БИЦЕПС НА НАКЛОННОЙ СКАМЬЕ\n"
                    "Тип: изолирующее, бицепс (длинная головка)\n\n"
                    "Техника:\n"
                    "• Угол скамьи 45–60°, спина прижата\n"
                    "• Руки свободно опущены — максимальное растяжение\n"
                    "• Сгибай только в локте, плечи неподвижны\n"
                    "• Супинация (разворот ладони) в верхней точке\n"
            ...
            },
            {
                ...
                "desc": (
                    "🔥 ТРИЦЕПС НА КАНАТЕ\n"
                    "Тип: изолирующее, трицепс\n\n"
                    "Техника:\n"
                    "• Блок сверху, рукоять-канат или V-bar\n"
            ...
            },
            {
                ...
                "sets": 3, "reps": "12", "rpe": "контроль", "step": "+1–2 повт",
                "rest": "60 сек",
                "desc": (
                    "🔥 PALLOF PRESS\n"
                    "Тип: антиротационное, стабилизация кора\n\n"
                    "Техника:\n"
                    "• Блок сбоку на уровне груди, стань боком к блоку\n"
            ...
            {
                "group": "Икры", "exercise": "Икры сидя",
                "sets": 3, "reps": "15–20", "rpe": "RIR 1–2", "step": "+2.5 кг",
                "rest": "60 сек",
                "desc": (
                    "🔥 ИКРЫ СИДЯ\n"
                    "Тип: изолирующее, камбаловидная мышца (солеус)\n\n"
                    "Техника:\n"
                    "• Сидя на тренажёре, валик на нижней части бёдер\n"
                    "• Пятки свисают — максимальное опускание вниз\n"
                    "• Поднимайся на максимальную высоту, задержка 1–2 сек\n"
                    "• Медленный эксцентрик 2–3 сек\n"
                    "• Сидячий вариант акцентирует солеус — другой угол vs стоя\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +2.5 кг"
                )
    ...
    "C": {
        "title": "ТРЕНИРОВКА C — НОГИ + АТЛЕТИК ⚡",
        "notes": ["Отдых: 45–60 сек"],
        "review_weeks": 10,
        "exercises": [
            {
                "group": "Грудь", "exercise": "Chest Press",
                "sets": 3, "reps": "15", "rpe": "7–8", "step": "след. стек",
                "rest": "45 сек",
                "desc": (
                    "⚡ CHEST PRESS (тренажёр)\n"
                    "Тип: многосуставное, метаболик\n\n"
                    "Техника:\n"
                    "• Спина прижата к спинке, хват нейтральный\n"
                    "• Жим вперёд до полного разгибания\n"
                    "• Медленный возврат — не теряй напряжение\n"
                    "• 15 повторов — высокий тоннаж, темп чёткий\n\n"
                    "Отдых: 45 сек\n"
                    "RPE: 7–8 (темповые, не до отказа)\n"
                    "Прогрессия: следующий стек"
                )
            },
            {
                "group": "Спина", "exercise": "Тяга верхнего блока",
                "sets": 3, "reps": "15", "rpe": "7–8", "step": "след. стек",
                "rest": "45 сек",
                "desc": (
                    "⚡ ТЯГА ВЕРХНЕГО БЛОКА\n"
                    "Тип: многосуставное, метаболик\n\n"
                    "Техника:\n"
                    "• Широкий хват, бёдра зафиксированы валиками\n"
                    "• Тяни к верхней части груди, локти вниз и назад\n"
                    "• Небольшой наклон корпуса назад — норма\n"
            ...
            },
            {
                ...
                "sets": 4, "reps": "12–15", "rpe": "7–8", "step": "+5–10 кг",
                "rest": "60 сек",
                "desc": (
                    "⚡ ЖИМ НОГАМИ (метаболик)\n"
                    "Тип: многосуставное, квадрицепсы / ягодицы\n\n"
                    "Техника:\n"
                    "• Стопы на ширине плеч, середина платформы\n"
                    "• Опускай до угла 90° в коленях\n"
                    "• Не отрывай поясницу от спинки\n"
                    "• Темп чёткий, без паузы в верхней точке\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: 7–8\n"
                    "Прогрессия: +5–10 кг"
                )
            },
            {
                ...
                "sets": 3, "reps": "10–12", "rpe": "7–8", "step": "+1–2 кг",
                "rest": "60 сек",
                "desc": (
                    "⚡ БОЛГАРСКИЕ ВЫПАДЫ\n"
                    "Тип: одноногое, ягодицы + квадрицепсы\n\n"
                    "Техника:\n"
                    "• Задняя нога на скамье, передняя — шаг вперёд\n"
                    "• Опускайся вертикально вниз, не вперёд\n"
                    "• Переднее колено не выходит за носок\n"
                    "• Корпус прямой, не наклоняй вперёд\n"
                    "• Выполняй все повторы на одну ногу, потом другую\n\n"
                    "Отдых: 60 сек (после каждой ноги)\n"
                    "RPE: 7–8\n"
                    "Прогрессия: +1–2 кг"
                )
            },
            {
                "group": "Задняя поверхность бедра", "exercise": "Румынская тяга",
                "sets": 3, "reps": "10–12", "rpe": "7–8", "step": "+2.5–5 кг",
                "rest": "60 сек",
                "desc": (
                    "⚡ РУМЫНСКАЯ ТЯГА\n"
                    "Тип: многосуставное, хамстринги + ягодицы\n\n"
                    "Техника:\n"
                    "• Штанга перед бёдрами, хват чуть шире плеч\n"
                    "• Колени слегка согнуты и ЗАФИКСИРОВАНЫ\n"
                    "• Наклоняй корпус вперёд, двигая таз назад\n"
                    "• Штанга ведёт по ногам — касается голеней\n"
                    "• Опускай до ощущения растяжения в хамстрингах\n"
                    "• Подъём — через разгибание бедра, не спиной\n\n"
                    "Отдых: 60 сек\n"
                    "RPE: 7–8\n"
                    "Прогрессия: +2.5–5 кг"
                )
            ...
            {
                "group": "Ноги", "exercise": "Сгибание ног лёжа",
                "sets": 2, "reps": "12–15", "rpe": "7–8", "step": "след. стек",
                "rest": "45 сек",
                "desc": (
                    "⚡ СГИБАНИЕ НОГ ЛЁЖА\n"
                    "Тип: изолирующее, бицепс бедра\n\n"
                    "Техника:\n"
                    "• Лёжа на животе, валик над пятками\n"
                    "• Сгибай до 90° или чуть дальше\n"
            ...
            },
            {
                ...
                "sets": 3, "reps": "12–15", "rpe": "7–8", "step": "+2.5–5 кг",
                "rest": "45 сек",
                "desc": (
                    "⚡ ЯГОДИЧНЫЙ МОСТ\n"
                    "Тип: изолирующее, ягодицы / задняя поверхность\n\n"
                    "Техника:\n"
                    "• Лёжа на спине, ноги согнуты, стопы на полу\n"
                    "• Штанга / гиря на бёдрах\n"
                    "• Поднимай таз до прямой линии бедро-корпус\n"
                    "• Пик сокращения — сожми ягодицы и задержи 1 сек\n"
                    "• Медленно опускай\n\n"
                    "Отдых: 45 сек\n"
                    "RPE: 7–8\n"
                    "Прогрессия: +2.5–5 кг"
            ...
            },
            {
                ...
                "sets": 3, "reps": "12 строгих / 10 читинг / 15 частичных", "rpe": "контроль", "step": "качество",
                "rest": "60 сек",
                "desc": (
                    "⚡ MECHANICAL DROP SET — РАЗВЕДЕНИЯ\n"
                    "Тип: интенсивная техника, средняя дельта\n\n"
                    "3 фазы без паузы:\n"
                    "1️⃣ 12 строгих — чистая техника, полная амплитуда\n"
                    "2️⃣ 10 читинг — небольшой импульс, чтобы продолжить\n"
                    "3️⃣ 15 частичных — малая амплитуда, жжение в дельте\n\n"
                    "Всё это = 1 подход без отдыха внутри\n"
                    "Отдых между подходами: 60 сек\n"
                    "RPE: контроль (акцент на качество жжения)\n"
                    "Прогрессия: улучшение техники"
                )
            },
            {
                "group": "Пресс", "exercise": "Подъём коленей в висе (медленно)",
                "sets": 3, "reps": "15", "rpe": "контроль", "step": "+1–2 повт",
                "rest": "45 сек",
                "desc": (
                    "⚡ ПОДЪЁМ КОЛЕНЕЙ В ВИСЕ (медленно)\n"
                    "Тип: изолирующее, нижний пресс\n\n"
                    "Техника:\n"
                    "• Вис на перекладине, тело стабильно\n"
                    "• Медленно поднимай колени к груди (2–3 сек вверх)\n"
                    "• Задержка 1 сек наверху\n"
                    "• Медленно опускай (2–3 сек вниз)\n"
                    "• Не раскачивайся — нет инерции\n\n"
                    "Отдых: 45 сек\n"
                    "RPE: контроль\n"
                    "Прогрессия: +1–2 повтора"
                )
            ...
            {
                "group": "Икры", "exercise": "Икры стоя",
                "sets": 3, "reps": "15–20", "rpe": "RIR 1–2", "step": "+2.5–5 кг",
                "rest": "45 сек",
                "desc": (
                    "⚡ ИКРЫ СТОЯ (метаболик)\n"
                    "Тип: изолирующее, икроножная мышца\n\n"
                    "Техника:\n"
                    "• Носки на краю платформы/степа, пятки свисают\n"
                    "• Полная амплитуда — максимум вниз и вверх\n"
                    "• Задержка 1 сек в верхней точке\n"
                    "• Медленный эксцентрик 2 сек\n\n"
                    "Отдых: 45 сек\n"
                    "RPE: RIR 1–2\n"
                    "Прогрессия: +2.5–5 кг"
                )
...
EXERCISE_CATALOG = sorted(set(
    ...
    ["Подтягивания", "Тяга штанги в наклоне", "Face Pull", "Reverse Pec Deck",
     ...
     "Шраги со штангой", "Икры стоя", "Икры сидя", "Cable Fly",
     "Румынская тяга", "Болгарские выпады"]
))
PAGE_SIZE = 8
